...
verteilungstabelle <- calculate_distribution(SAFEPD, "school_graduation", "Schulabschluss")
...
verteilungstabelleB <- calculate_distribution(SAFEPD, "professional_graduation", "Berufsabschluss")
...
verteilungstabelleM <- calculate_distribution(SAFEPD, "martial_status", "Familienstand")
...
verteilungstabelleH <- calculate_distribution(SAFEPD, "persons_houshold", "Haushalt")
...
Vergleich_Haushalt <- read_excel("~/SAFEPD/SAFEPD_imputeddata.xlsx", sheet = "Vergleichsdaten", range = "A26:B31")
...
# Anwendung für Alter
verteilungstabelleA <- calculate_distribution(SAFEPD, "age", "Alter")
...
Vergleich_Alter <- read_excel("~/SAFEPD/SAFEPD_imputeddata.xlsx", sheet = "Vergleichsdaten", range = "A33:B40")
